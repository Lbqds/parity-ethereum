...
pub fn new_foundation() -> Spec {
	load(include_bytes!("../../res/ethereum/foundation.json"))
}

/// Create a new Classic mainnet chain spec without the DAO hardfork.
pub fn new_classic() -> Spec {
	load(include_bytes!("../../res/ethereum/classic.json"))
}

/// Create a new POA Network mainnet chain spec.
pub fn new_poanet() -> Spec {
	load(include_bytes!("../../res/ethereum/poacore.json"))
}

/// Create a new Tobalaba mainnet chain spec.
pub fn new_tobalaba() -> Spec {
	load(include_bytes!("../../res/ethereum/tobalaba.json"))
}

/// Create a new Expanse mainnet chain spec.
pub fn new_expanse() -> Spec {
	load(include_bytes!("../../res/ethereum/expanse.json"))
}
...
pub fn new_ropsten_test() -> Spec { load(include_bytes!("../../res/ethereum/ropsten.json")) }
...
pub fn new_byzantium_test() -> Spec { load(include_bytes!("../../res/ethereum/byzantium_test.json")) }

/// Create a new Foundation Constantinople era spec.
pub fn new_constantinople_test() -> Spec { load(include_bytes!("../../res/ethereum/constantinople_test.json")) }

/// Create a new Musicoin-MCIP3-era spec.
pub fn new_mcip3_test() -> Spec { load(include_bytes!("../../res/ethereum/mcip3_test.json")) }
